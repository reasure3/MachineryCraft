...
import com.reasure.machinerycraft.item.DebugItem;
import com.reasure.machinerycraft.item.ModArmorMaterials;
...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, MachineryCraft.MODID);
    ...
    public static final RegistryObject<Item> SILVER_HORSE_ARMOR = ITEMS.register("silver_horse_armor", () ->
            new HorseArmorItem(9, new ResourceLocation(MachineryCraft.MODID, "textures/entity/horse/armor/horse_armor_silver.png"),
